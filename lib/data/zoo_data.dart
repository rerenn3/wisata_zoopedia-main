...
var zooList = [
  ...
  Zoo(
    nama: 'Lembang Park and Zoo',
    lokasi: 'Bandung Barat, Jawa Barat',
    deskripsi:
    'Lembang Park & Zoo adalah destinasi eduwisata bagi keluarga yang memungkinkan wisatawan bermain di taman sambil menambah ilmu pengetahuan dan berinteraksi secara langsung dengan beragam satwa eksotis. Konsep unik dengan tampilan arsitektur yang modern dan fasilitas berkualitas tinggi yang ditawarkan merupakan keunggulan dari Lembang Park & Zoo. Saat ini Lembang Park & Zoo setidaknya memiliki 600 ekor binatang diantaranya berbagai jenis pisces, reptilia, aves, dan mamalia',
    dibangun: 'Tahun 2019',
    luas: '18 hektar',
  ...
  Zoo(
    ...
    deskripsi:
    'Gembira Loka Zoo adalah Kebun Raya dan Kebun Binatang yang berada di Kota Yogyakarta. Memiliki berbagai wahana rekreasi seperti interaksi satwa, kolam sentuh, kolam tangkap, terapi ikan, perahu kayuh, skuter air, atv, bumper boat, speed boat, perahu katamaran, dan lain lain.',
    dibangun: 'Tahun 1956',
    luas: '21,8 hektar',
  ...
  Zoo(
    nama: 'Lombok Wildlife Park',
    lokasi: 'Lombok, Nusa Tenggara Barat',
    deskripsi:
    'Lombok Wildlife Park adalah destinasi wisata pilihan ketika berencana liburan ke Nusa Tenggara Barat. Selain melihat koleksi hewan yang ada, Lombok Wildlife Park menawarkan berbagai pengalaman unik seperti memandikan gajah yang pasti sangat seru jika dilakukan bersama keluarga.',
    dibangun: 'Tahun 2011',
    luas: '9 hektar',
    imageAsset: 'images/Lombok.jpg',
    imageUrls: [
      '',
  ...
  Zoo(
    nama: ' Kebun Binatang Lembah Hijau Lampung',
    lokasi: 'Bandar Lampung, Lampung',
    deskripsi:
    'Taman Wisata Lembah Hijau Lampung adalah salah-satu wisata Lampung yang memadukan berbagai konsep wisata yang disajikan dalam satu lokasi, atau kawasan yang sama. Objek wisata alam yang dipadukan dengan ragam wahana wisata keluarga, dan wahana kekinian.',
    dibangun: 'Tahun 2006',
    luas: '30 hektar',
